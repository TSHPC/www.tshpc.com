...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { event_id: @registration.event_id, user_id: @registration.user_id } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { event_id: @registration.event_id, user_id: @registration.user_id } }
